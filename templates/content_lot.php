          ...
          <div class="lot-item__state">
            ...
            <div class="lot-item__cost-state">
              <div class="lot-item__rate">
                ...
                <span class="lot-item__cost"><?=format_price(htmlspecialchars($open_lot['start_price'])) ?></span>
              </div>
              <div class="lot-item__min-cost">
                Мин. ставка <span><?=format_price(min_bet($open_lot['start_price'], $open_lot['step_price'])); ?></span>
              </div>
            </div>
            ...
            <table class="history__list">
              <?php /*foreach ($bet_open_lot as $bet): ?>
                <tr class="history__item">
                  ...
                  <?php $time_age = get_dt_range_back($bet['date_create']);
                  $hour = $time_age[0];?>
                  <td class="history__time"><?=$time_age[2] ?></td>
                </tr>                                        
              <?php endforeach;*/ ?>  
